...
function useBrowserState(defaultValue, {
  ...
  const [defaultKey] = react.useState( // Need to slice since keys can get really big
  ...
  const debounceSaveToLocalStorage = react.useCallback(countedDebounce((key, value) => {
...
exports.reset = reset;
exports.setSaveWait = setSaveWait;
exports.useBrowserState = useBrowserState;
exports.useIsBrowserStateSaving = useIsBrowserStateSaving;
